...
\title{Face Tracking for Optimized Bitrate Bontrol in Low Delay Video Encoding}
...
\section{Introduction}
  \subsection{Low Delay Bitrate Control}
     ...
     \par	
The bitrate control module is encoder is responsible for controlling the bit-consumption of the encoder to guarantee smooth playback. Bitrate control module is not codec specific and operates  .During the low delay video encoding, tools like bi-directional prediction are disabled
