...
The image in fugure \ref{fig:PaulDefault120} shows a frame in the sample video conferencing content. The iamge in [ ??] shows the same frame when encoded with the codec configurations discussed in <section> with 250 kbps. 
